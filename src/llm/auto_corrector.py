...
- If the project makes no sense at all or its logic is not relevant to the problem, return the project json with the keys kept and the values empty"""
        ...
        def wrapper(*args, **kwargs):
            ...
            for attempt in range(max_retries + 1):
                try:
                    ...
                    if error.code not in retry_on or attempt == max_retries:
                        raise
